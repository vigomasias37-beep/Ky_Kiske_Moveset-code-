...
pub fn install(agent: &mut smashline::Agent) {
    ...
    agent.acmd("game_attackairb", game_attackairb, smashline::Priority::Default);
    agent.acmd("game_attackairf", game_attackairf, smashline::Priority::Default);
    agent.acmd("game_attackairlw", game_attackairlw, smashline::Priority::Default);
    agent.acmd("game_attackairn", game_attackairn, smashline::Priority::Default);
    agent.effect_acmd("effect_attackairlw", effect_attackairlw, smashline::Priority::Default);
}
